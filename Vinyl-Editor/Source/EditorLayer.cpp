...
#include <Vinyl/Asset/TextureImporter.h>
#include <Vinyl/Asset/SceneImporter.h>
...
namespace Vinyl
{
	...
	void EditorLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<WindowDropEvent>(VL_BIND_EVENT_FN(EditorLayer::OnWindowDrop));
	}
