...
namespace Vinyl
{
	...
	void SceneHierarchyPanel::OnImGuiRender()
	{
		...
		// Assuming m_Context->m_Registry is an entt::registry object
		auto view = m_Context->m_Registry.view<entt::entity>(); // Get a view of all entities
	...
	static void DrawVerticalEllipsis(float lineHeight)
	{
		...
		// First dot (move slightly up)
		ImGui::SetCursorScreenPos(ImVec2(buttonPos.x + buttonSize.x * 0.5f - ImGui::CalcTextSize(".").x * 0.5f, buttonPos.y - 5.0f));
		ImGui::Text(".");

		// Second dot (move closer to the first dot)
		ImGui::SetCursorScreenPos(ImVec2(buttonPos.x + buttonSize.x * 0.5f - ImGui::CalcTextSize(".").x * 0.5f, buttonPos.y));
		ImGui::Text(".");

		// Third dot (move even closer)
		ImGui::SetCursorScreenPos(ImVec2(buttonPos.x + buttonSize.x * 0.5f - ImGui::CalcTextSize(".").x * 0.5f, buttonPos.y + 5.0f));
		ImGui::Text(".");
	}
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (ImGui::BeginPopup("AddComponent"))
		{
			if (ImGui::MenuItem("Camera"))
			{
				...
				{
					VL_CORE_WARN("This entity already has the Camera Component!");
				}
			...
			if (ImGui::MenuItem("Sprite Renderer"))
			{
				...
				{
					VL_CORE_WARN("This entity already has the Sprite Renderer Component!");
				}
		...
		DrawComponent<CameraComponent>("Camera", entity, [](auto& cameraComponent)
		{
				...
				ImGui::Checkbox("Main Camera", &cameraComponent.MainCamera);
